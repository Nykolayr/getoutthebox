...
class _TherapeuticGamesState extends State<TherapeuticGames> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TherapeuticGameBloc()..add(GetTherapeuticGame()),
      child: Scaffold(
        key: _scaffoldKey,
                ...
                child: Container(
                  ...
                  child: BlocBuilder<TherapeuticGameBloc, TherapeuticGameState>(
                    builder: (context, state) {
                      if (state is TherapeuticGameLoading) {
                        return const Center(
                          child: CircularProgressIndicator(
                            color: StyleManager.mainColor,
                          ),
                        );
                      } else if (state is TherapeuticGameSuccess) {
                        final games = state.gamesList.games;
